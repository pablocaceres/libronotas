            ...
            <div class="block">
                <div class="navbar navbar-inner block-header">
                    ...
                    <div class="muted pull-right">
                        <a href=<?php echo site_url();?>/facultad/nueva_facultad><button class="btn btn-success">Nuevo</button> </a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=<?php echo site_url();?>/facultad/editar_facultad/<?php echo $v->id;?>><button class="btn">Editar</button></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Desea eliminar esta facultad?</p>
      ...
      <div class="modal-footer">
        <button class="btn btn-danger" onclick="eliminar_reg('<?php echo site_url();?>/facultad/eliminar_facultad/')">Eliminar</button>
