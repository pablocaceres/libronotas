            ...
            <div class="block">
                <div class="navbar navbar-inner block-header">
                    ...
                    <div class="muted pull-right">
                        <a href="referente/new_referente"><button class="btn btn-success">Nuevo</button></a>
                    </div>
                </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>                                   
                                    ...
                                    <th width="auto">Tel institucional</th>
                                    <th width="auto">Tel personal</th>
                                    <th width="auto">Grado</th>
                                    <th width="auto">Institucion</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $v->tel_inst;?></td>
                                    <td><?php echo $v->tel_per;?></td>
                                    <td><?php echo $v->grado;?></td>
                                    <td><?php echo $v->institucion;?></td>
                                    <td>
                                    	<a href=<?php echo site_url();?>/grado/editar_grado/<?php echo $v->id;?>><button class="btn">Editar</button></a>
                                    	<button type="button" class="btn btn-danger" onclick="eliminar('<?php echo $v->id;?>','<?php echo $v->Apellido;?>')">Eliminar</button>
                                    </td>                                    
                                </tr>
                                <?php
                            		}
