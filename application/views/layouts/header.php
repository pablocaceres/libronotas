...
<html class="no-js">
    ...
    <head>
       <!--  <title><?php echo $titulo;?></title>
        ...
        <!-- jQuery -->
        <script type="text/javascript" language="javascript" src="<?php echo base_url('public/vendors/jquery-2.2.3.js');?>"></script>
        <!-- DataTables CSS -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/datatable/css/jquery.dataTables.css');?>">
        <!-- DataTables  JS-->
        <script type="text/javascript" src="<?php echo base_url('public/datatable/js/jquery.dataTables.js');?>"></script>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('index.php/login/logout');?>"><i class="fa fa-sign-out fa-fw"></i>Cerrar sesión</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <!-- <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="#">Ofertas Tecnológicas UNNE</a>
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li>
                                <a href="<?php echo base_url('index.php/usuario/');?>">Usuarios</a>
                            </li>

                            <li>
                                <a href="<?php echo base_url('index.php/libro/');?>">Libro</a>
                            </li> -->
